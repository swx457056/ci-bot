...
func NewHelpAgent(pa pluginAgent, ghc *github.Client) *HelpAgent {
...
func externalHelpProvider(log *logrus.Entry, endpoint string) ExternalPluginHelpProvider {
...
func newOrgAgent(log *logrus.Entry, ghc *github.Client, syncPeriod time.Duration) *orgAgent {
	return &orgAgent{
		log:        log,
		ghc:        ghc,
