...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	//eventType, eventGUID, payload, _,_ := github.ValidateWebhook(w, r, s.TokenGenerator())
	//payload , err := hub.ValidatePayload(r,[]byte(s.Config.WebhookSecret))
	//if err != nil{
	//	glog.Errorf("Invalid payload: %v",err)
	//	return
	//}
	//event,err := hub.ParseWebHook(hub.WebHookType(r),payload)
	//if err != nil{
