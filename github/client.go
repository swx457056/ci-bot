...
func (c *Client) request(r *request, ret interface{}) (int, error) {
	fmt.Println("Inside the request method:r", r)
	fmt.Println("Inside the request method:ret", ret)
...
func (c *Client) AssignIssue(org, repo string, number int, logins []string) error {
	fmt.Println("&&&&&& Inside the Assign issue &&&&&&&&")
	fmt.Println("*********** c ********* ", c)
	c.log("AssignIssue", org, repo, number, logins)
	fmt.Println("Inside AssignIssue:org", org)
	fmt.Println("Inside AssignIssue:repo", repo)
	fmt.Println("Inside AssignIssue:number", number)
	fmt.Println("Inside AssignIssue:logins", logins)
	...
	for _, assignee := range i.Assignees {
		fmt.Println("Inside Assign Issue", assignee)
		assigned[NormLogin(assignee.Login)] = true
		fmt.Println("Inside assignee : ", assigned)
	}
